...
if(!row7.Prenom.trim().equals("") && row7.Prenom.toLowerCase().matches("[ `'a-zA-Z-_.éÉÈèêÊ/]+") ){
...
if( !row9.Nom_de_Famille.trim().equals("") && row9.Nom_de_Famille.toLowerCase().matches("[ `'a-zA-Z-_.éÉÈèêÊ/]+")){
  ...
  for(int j=0; j < p.length; j++){ 
     ...
     if(j == 1){
        ...
        if(i == 1){
          ...
          p11 = p[1].trim().equals(row15.INAM);
        }
  
  
        if(i == 2){

           p21 = p[1].trim().equals(row15.NNI);
        }
  
  
        if(i == 3){
        
           p31 = p[1].trim().equals(row15.Prenom);
    
        }

        if(i == 5){

          p51 = p[1].trim().equals(row15.Nom_de_Famille);
        }
 ...
 */
	...
	currentComponent="tUnite_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"row31","row30");
					}
...
globalMap.put("tUnite_1_NB_LINE", nb_line_tUnite_1);
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"row31","row30");
			  	}
...
/************************************************************************************************
 *     724829 characters generated by Talend Open Studio for Data Integration 
 *     on the July 25, 2022 11:44:43 AM GMT
 ************************************************************************************************/